...
package com.app.videorecorder.glide.gpuimage;

import android.annotation.SuppressLint;
import android.opengl.GLES20;

import com.app.videorecorder.glide.gpuimage.util.TextureRotationUtil;
...
import static com.app.videorecorder.glide.gpuimage.GPUImageRenderer.CUBE;
import static com.app.videorecorder.glide.gpuimage.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see com.app.videorecorder.glide.gpuimage.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see com.app.videorecorder.glide.gpuimage.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.app.videorecorder.glide.gpuimage.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.app.videorecorder.glide.gpuimage.GPUImageFilter#onDraw(int,
