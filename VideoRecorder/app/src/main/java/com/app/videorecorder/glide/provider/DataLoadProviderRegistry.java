...
import com.app.videorecorder.glide.util.MultiClassKey;

import java.util.HashMap;
import java.util.Map;

/**
 * A class that allows {@link com.app.videorecorder.glide.provider.DataLoadProvider}s to be registered and retrieved by the
...
public class DataLoadProviderRegistry {
    ...
    /**
     * Registers the given {@link com.app.videorecorder.glide.provider.DataLoadProvider} using the given classes so it can later
    ...
    /**
     * Returns the currently registered {@link com.app.videorecorder.glide.provider.DataLoadProvider} for the given classes.
     *
     * @param dataClass The class of the data that the provider provides encoders and decoders for.
     * @param resourceClass The class of the resource that the provider provides encoders and decoders for.
     * @param <T> The type of the data that the provider provides encoders and decoders for.
