...
/**
 * A {@link com.app.videorecorder.glide.request.animation.GlideAnimationFactory} that produces
 * {@link com.app.videorecorder.glide.request.animation.ViewAnimation}s.
 *
...
public class ViewAnimationFactory<R> implements GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link com.app.videorecorder.glide.request.animation.GlideAnimation} for the given arguments. If
     * isFromMemoryCache is {@code true} or isFirstImage is {@code false}, returns a
     * {@link com.app.videorecorder.glide.request.animation.NoAnimation} and otherwise returns a new
