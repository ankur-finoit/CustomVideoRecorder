...
/**
 * An {@link com.app.videorecorder.glide.load.ResourceDecoder} for decoding {@link android.graphics.Bitmap}s from
...
public class FileDescriptorBitmapDecoder implements ResourceDecoder<ParcelFileDescriptor, Bitmap> {
    ...
    @Override
    public String getId() {
        return "FileDescriptorBitmapDecoder.com.app.videorecorder.glide.load.data.bitmap";
    }
}
