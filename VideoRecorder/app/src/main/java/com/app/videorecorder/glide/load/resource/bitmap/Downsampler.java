...
import com.app.videorecorder.glide.util.ByteArrayPool;
import com.app.videorecorder.glide.util.ExceptionCatchingInputStream;
import com.app.videorecorder.glide.util.MarkEnforcingInputStream;
...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    ...
    public static final Downsampler AT_LEAST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_LEAST.com.app.videorecorder.glide.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler AT_MOST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_MOST.com.app.videorecorder.glide.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler NONE = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "NONE.com.app.videorecorder.glide.load.data.bitmap";
        }
    };
