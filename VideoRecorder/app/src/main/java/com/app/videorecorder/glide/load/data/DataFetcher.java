package com.app.videorecorder.glide.load.data;
 ...
 * resource load by {@link com.app.videorecorder.glide.load.model.ModelLoader}. {@link #loadData(Priority)} may or may not be
...
public interface DataFetcher<T> {
     ...
     * {@link com.app.videorecorder.glide.load.ResourceDecoder}.
     *
     * <p>
     *     Note - this method will be run on a background thread so blocking I/O is safe.
     * </p>
