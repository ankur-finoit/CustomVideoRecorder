package com.app.videorecorder.glide.load.model;
 ...
 * @param <Y> The type of the data that can be used by a {@link com.app.videorecorder.glide.load.ResourceDecoder} to decode a
 *           resource.
 */
public interface ModelLoader<T, Y> {
     ...
     *              {@link com.app.videorecorder.glide.request.target.Target#SIZE_ORIGINAL} to indicate that the resource should
     ...
     * cached, or null if no valid {@link com.app.videorecorder.glide.load.data.DataFetcher} could be constructed.
     */
