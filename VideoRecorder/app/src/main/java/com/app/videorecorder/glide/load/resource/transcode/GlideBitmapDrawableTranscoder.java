...
import com.app.videorecorder.glide.load.resource.bitmap.GlideBitmapDrawableResource;
...
public class GlideBitmapDrawableTranscoder implements ResourceTranscoder<Bitmap, GlideBitmapDrawable> {
    ...
    @Override
    public String getId() {
        return "GlideBitmapDrawableTranscoder.com.app.videorecorder.glide.load.resource.transcode";
    }
}
