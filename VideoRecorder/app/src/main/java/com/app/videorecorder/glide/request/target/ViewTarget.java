...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
     ...
     *   on older versions, be sure to call {@link com.app.videorecorder.glide.Glide#clear(View)} on any view
     ...
     *     that is not an {@link com.app.videorecorder.glide.request.Request}.
     * </p>
     */
    @Override
