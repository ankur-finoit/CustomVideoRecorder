...
import com.app.videorecorder.glide.load.engine.DiskCacheStrategy;
import com.app.videorecorder.glide.load.model.ModelLoader;
import com.app.videorecorder.glide.load.model.file_descriptor.FileDescriptorModelLoader;
import com.app.videorecorder.glide.load.model.stream.MediaStoreStreamLoader;
import com.app.videorecorder.glide.load.model.stream.StreamByteArrayLoader;
import com.app.videorecorder.glide.load.model.stream.StreamModelLoader;
import com.app.videorecorder.glide.manager.ConnectivityMonitor;
import com.app.videorecorder.glide.manager.ConnectivityMonitorFactory;
import com.app.videorecorder.glide.manager.Lifecycle;
import com.app.videorecorder.glide.manager.LifecycleListener;
import com.app.videorecorder.glide.manager.RequestManagerTreeNode;
import com.app.videorecorder.glide.manager.RequestTracker;
import com.app.videorecorder.glide.signature.ApplicationVersionSignature;
import com.app.videorecorder.glide.signature.MediaStoreSignature;
import com.app.videorecorder.glide.signature.StringSignature;
...
public class RequestManager implements LifecycleListener {
     ...
     * {@link com.app.videorecorder.glide.RequestManager}.
     */
     ...
     *
     * <p>
     *     Note - These options will be retained for the life the of this {@link com.app.videorecorder.glide.RequestManager}
     *     so be wary of using
     *     {@link com.app.videorecorder.glide.GenericRequestBuilder#listener(com.app.videorecorder.glide.request.RequestListener)}} when
    ...
    /**
     * Returns a request builder that uses the given {@link com.app.videorecorder.glide.load.model.ModelLoader} to fetch a
     * generic data type.
     *
     * <p>
    ...
    /**
     * Returns a request builder that uses the given {@link com.app.videorecorder.glide.load.model.stream.StreamModelLoader} to
     ...
     * {@link com.app.videorecorder.glide.load.model.stream.StreamByteArrayLoader} to fetch an {@link java.io.InputStream} for
     * loading Bitmaps.
     *
     ...
     * @see #load(Object)
     *
     * @param string A file path, or a uri or url handled by {@link com.app.videorecorder.glide.load.model.UriLoader}.
     */
     ...
     *     {@link com.app.videorecorder.glide.GenericRequestBuilder#signature(com.app.videorecorder.glide.load.Key)} to mixin a signature
     *     you create that identifies the data currently at the given String that will invalidate the cache if that data
     *     changes. Alternatively, using {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.app.videorecorder.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     * @see #load(String)
     ...
     * {@link com.app.videorecorder.glide.load.model.UriLoader}.
     */
     ...
     *     Alternatively, using {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.app.videorecorder.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     ...
     * @see com.app.videorecorder.glide.GenericRequestBuilder#signature(com.app.videorecorder.glide.load.Key)
     */
     ...
     * @see com.app.videorecorder.glide.GenericRequestBuilder#signature(com.app.videorecorder.glide.load.Key)
     * @see com.app.videorecorder.glide.signature.MediaStoreSignature
     *
     * @deprecated Use {@link #loadFromMediaStore(android.net.Uri)},
     * {@link com.app.videorecorder.glide.signature.MediaStoreSignature}, and
     * {@link com.app.videorecorder.glide.DrawableRequestBuilder#signature(com.app.videorecorder.glide.load.Key)} instead. Scheduled to be
     ...
     *
     * <p>
     *  Falls back to the registered {@link com.app.videorecorder.glide.load.model.ModelLoaderFactory} registered for
     ...
     *     {@link com.app.videorecorder.glide.GenericRequestBuilder#signature(com.app.videorecorder.glide.load.Key)} to mix in some
     *     additional data identifying the current state of the Uri, preferably using
     *     {@link com.app.videorecorder.glide.signature.MediaStoreSignature}. Alternatively consider avoiding the memory and
     *     disk caches entirely using
     *     {@link GenericRequestBuilder#diskCacheStrategy(com.app.videorecorder.glide.load.engine.DiskCacheStrategy)}
     *     and {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.app.videorecorder.glide.GenericRequestBuilder#skipMemoryCache(boolean)}.
     * </p>
     *
     * @see #from(Class)
     * @see #loadFromMediaStore(android.net.Uri, String, long, int)
    ...
    /**
     * Returns a request builder that uses the {@link com.app.videorecorder.glide.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@link com.app.videorecorder.glide.load.model.stream.StreamFileLoader.Factory} and
     * {@link com.app.videorecorder.glide.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     *
     *  <p>
     ...
     * to {@link com.app.videorecorder.glide.load.model.stream.StreamResourceLoader.Factory} and
     * {@link com.app.videorecorder.glide.load.model.stream.StreamResourceLoader} to load resource id models.
     *
     * <p>
     ...
     *     cached data. To get around this, consider using {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#NONE}
     *     via {@link GenericRequestBuilder#diskCacheStrategy(com.app.videorecorder.glide.load.engine.DiskCacheStrategy)}
     *     during development, and re-enabling the default
     *     {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#RESULT} for release builds.
     * </p>
     *
     * @see #from(Class)
     * @see #load(Integer)
     * @see com.app.videorecorder.glide.signature.ApplicationVersionSignature
     * @see com.app.videorecorder.glide.GenericRequestBuilder#signature(com.app.videorecorder.glide.load.Key)
     */
     ...
     * {@link com.app.videorecorder.glide.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@link com.app.videorecorder.glide.load.data.HttpUrlFetcher} to load {@link java.net.URL} models.
     *
     * @see #from(Class)
     ...
     * {@link com.app.videorecorder.glide.GenericRequestBuilder#signature(com.app.videorecorder.glide.load.Key)} instead. Scheduled to be
     * removed in Glide 4.0.
    ...
    /**
     * Returns a request builder that uses {@link com.app.videorecorder.glide.load.model.stream.StreamByteArrayLoader} to load
    ...
    /**
     * Returns a request builder that uses the {@link com.app.videorecorder.glide.load.model.ModelLoaderFactory}s currently
     ...
     * {@link com.app.videorecorder.glide.load.model.ModelLoaderFactory}s registered for the given model class for
     ...
     *
     * <p>
     *     Note - you must use {@link com.app.videorecorder.glide.DrawableRequestBuilder#load(Object)}} to set a concrete model
     *     to be loaded before calling
     *     {@link com.app.videorecorder.glide.DrawableRequestBuilder#into(com.app.videorecorder.glide.request.target.Target)}. You may
     *     also use this object for repeated loads by calling <code>request.load(model).into(target)</code>. You may
     *     also adjust the options after calling {@link com.app.videorecorder.glide.DrawableRequestBuilder#load(Object)}} and/or
     *     {@link com.app.videorecorder.glide.DrawableRequestBuilder#into(com.app.videorecorder.glide.request.target.Target)}}. However,
    ...
    public final class ImageModelRequest<T> {
        ...
        /**
         * Returns a request builder that uses the provided {@link com.app.videorecorder.glide.load.model.ModelLoader} to load
     ...
     * @param <T> The type of data the {@link com.app.videorecorder.glide.load.model.ModelLoader} provides an
     * {@link com.app.videorecorder.glide.load.data.DataFetcher} to convert the model to.
     */
    public final class GenericModelRequest<A, T> {
        ...
        /**
         * A helper class for building requests with custom {@link com.app.videorecorder.glide.load.model.ModelLoader}s that
