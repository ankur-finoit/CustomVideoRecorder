...
/**
 * A simple {@link com.app.videorecorder.glide.request.animation.GlideAnimation} that performs no actions.
 *
...
public class NoAnimation<R> implements GlideAnimation<R> {
    ...
    /**
     * A factory that always returns the same {@link com.app.videorecorder.glide.request.animation.NoAnimation}.
     */
    ...
    /**
     * Returns an instance of a factory that produces {@link com.app.videorecorder.glide.request.animation.NoAnimation}s.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns an instance of {@link com.app.videorecorder.glide.request.animation.NoAnimation}.
     */
    @SuppressWarnings("unchecked")
