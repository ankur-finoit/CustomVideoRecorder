...
/**
 * An {@link com.app.videorecorder.glide.load.ResourceEncoder} that writes {@link android.graphics.Bitmap}s to
...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
    ...
    @Override
    public String getId() {
        return "BitmapEncoder.com.app.videorecorder.glide.load.resource.bitmap";
    }
