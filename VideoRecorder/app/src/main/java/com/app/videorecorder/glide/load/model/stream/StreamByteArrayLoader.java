...
import com.app.videorecorder.glide.load.data.ByteArrayFetcher;
...
public class StreamByteArrayLoader implements StreamModelLoader<byte[]> {
    ...
    /**
     * @deprecated Use {@link com.app.videorecorder.glide.GenericRequestBuilder#signature(com.app.videorecorder.glide.load.Key)}
    ...
    /**
     * Factory for {@link com.app.videorecorder.glide.load.model.stream.StreamByteArrayLoader}.
     */
