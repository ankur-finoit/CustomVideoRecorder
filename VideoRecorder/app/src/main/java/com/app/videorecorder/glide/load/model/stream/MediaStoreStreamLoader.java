...
import com.app.videorecorder.glide.load.data.MediaStoreThumbFetcher;
import com.app.videorecorder.glide.load.model.ModelLoader;

import java.io.InputStream;

/**
 * An {@link com.app.videorecorder.glide.load.model.ModelLoader} that can use media store uris to open pre-generated thumbnails
 ...
 * it falls back to the wrapped {@link com.app.videorecorder.glide.load.model.ModelLoader} to load the
