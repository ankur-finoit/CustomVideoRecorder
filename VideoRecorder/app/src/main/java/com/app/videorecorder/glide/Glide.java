...
import com.app.videorecorder.glide.load.engine.Engine;
import com.app.videorecorder.glide.load.engine.bitmap_recycle.BitmapPool;
import com.app.videorecorder.glide.load.engine.cache.DiskLruCacheFactory;
import com.app.videorecorder.glide.load.engine.cache.MemoryCache;
import com.app.videorecorder.glide.load.engine.prefill.BitmapPreFiller;
import com.app.videorecorder.glide.load.engine.prefill.PreFillType;
...
import com.app.videorecorder.glide.load.model.file_descriptor.FileDescriptorFileLoader;
import com.app.videorecorder.glide.load.model.file_descriptor.FileDescriptorResourceLoader;
import com.app.videorecorder.glide.load.model.file_descriptor.FileDescriptorStringLoader;
import com.app.videorecorder.glide.load.model.file_descriptor.FileDescriptorUriLoader;
import com.app.videorecorder.glide.load.model.stream.HttpUrlGlideUrlLoader;
import com.app.videorecorder.glide.load.model.stream.StreamByteArrayLoader;
import com.app.videorecorder.glide.load.model.stream.StreamFileLoader;
import com.app.videorecorder.glide.load.model.stream.StreamResourceLoader;
import com.app.videorecorder.glide.load.model.stream.StreamStringLoader;
import com.app.videorecorder.glide.load.model.stream.StreamUriLoader;
import com.app.videorecorder.glide.load.model.stream.StreamUrlLoader;
import com.app.videorecorder.glide.load.resource.bitmap.CenterCrop;
import com.app.videorecorder.glide.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import com.app.videorecorder.glide.load.resource.bitmap.FitCenter;
import com.app.videorecorder.glide.load.resource.bitmap.GlideBitmapDrawable;
import com.app.videorecorder.glide.load.resource.bitmap.ImageVideoDataLoadProvider;
import com.app.videorecorder.glide.load.resource.bitmap.StreamBitmapDataLoadProvider;
import com.app.videorecorder.glide.load.resource.drawable.GlideDrawable;
import com.app.videorecorder.glide.load.resource.file.StreamFileDataLoadProvider;
import com.app.videorecorder.glide.load.resource.gif.GifDrawable;
import com.app.videorecorder.glide.load.resource.gif.GifDrawableLoadProvider;
import com.app.videorecorder.glide.load.resource.gifbitmap.GifBitmapWrapper;
import com.app.videorecorder.glide.load.resource.gifbitmap.GifBitmapWrapperTransformation;
import com.app.videorecorder.glide.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import com.app.videorecorder.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import com.app.videorecorder.glide.load.resource.transcode.GlideBitmapDrawableTranscoder;
import com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder;
import com.app.videorecorder.glide.load.resource.transcode.TranscoderRegistry;
import com.app.videorecorder.glide.manager.RequestManagerRetriever;
import com.app.videorecorder.glide.module.GlideModule;
import com.app.videorecorder.glide.module.ManifestParser;
import com.app.videorecorder.glide.provider.DataLoadProvider;
import com.app.videorecorder.glide.provider.DataLoadProviderRegistry;
import com.app.videorecorder.glide.request.FutureTarget;
import com.app.videorecorder.glide.request.Request;
import com.app.videorecorder.glide.request.animation.GlideAnimation;
import com.app.videorecorder.glide.request.target.ImageViewTargetFactory;
import com.app.videorecorder.glide.request.target.Target;
import com.app.videorecorder.glide.request.target.ViewTarget;
 ...
 * maintaining an {@link Engine}, {@link BitmapPool}, {@link com.app.videorecorder.glide.load.engine.cache.DiskCache} and
 * {@link MemoryCache}.
 */
public class Glide {
     ...
     *
     * @deprecated Use {@link com.app.videorecorder.glide.module.GlideModule} instead. Scheduled to be removed in Glide 4.0.
     */
    @Deprecated
    ...
    /**
     * Returns the {@link com.app.videorecorder.glide.load.engine.bitmap_recycle.BitmapPool} used to temporarily store
     ...
     *     {@link com.app.videorecorder.glide.load.ResourceDecoder}s and {@link com.app.videorecorder.glide.load.Transformation}s. Use
    ...
    /**
     * Pre-fills the {@link com.app.videorecorder.glide.load.engine.bitmap_recycle.BitmapPool} using the given sizes.
     *
     * <p>
     ...
     *     re-filling the {@link com.app.videorecorder.glide.load.engine.bitmap_recycle.BitmapPool}. Rotation should be carefully
     ...
     *     {@link com.app.videorecorder.glide.load.engine.prefill.PreFillType.Builder Builders} representing
     ...
     * models. Typically the {@link RequestManager#using(com.app.videorecorder.glide.load.model.stream.StreamModelLoader)} or
     * {@link RequestManager#using(com.app.videorecorder.glide.load.model.file_descriptor.FileDescriptorModelLoader)} syntax is
     ...
     * </p>
     *
     * @see RequestManager#using(com.app.videorecorder.glide.load.model.file_descriptor.FileDescriptorModelLoader)
     * @see RequestManager#using(com.app.videorecorder.glide.load.model.stream.StreamModelLoader)
     *
     ...
     *
     * @deprecated Use {@link #register(Class, Class, com.app.videorecorder.glide.load.model.ModelLoaderFactory)} to replace
