...
/**
 * A factory class that can produce different {@link com.app.videorecorder.glide.request.animation.GlideAnimation}s based on the
...
public interface GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link com.app.videorecorder.glide.request.animation.GlideAnimation}.
     *
