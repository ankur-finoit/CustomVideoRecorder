...
import com.app.videorecorder.glide.load.resource.bitmap.BitmapTransformation;
import com.app.videorecorder.glide.load.resource.bitmap.Downsampler;
import com.app.videorecorder.glide.load.resource.bitmap.FileDescriptorBitmapDecoder;
import com.app.videorecorder.glide.load.resource.bitmap.ImageVideoBitmapDecoder;
import com.app.videorecorder.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.app.videorecorder.glide.load.resource.bitmap.VideoBitmapDecoder;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
     ...
     * {@link com.app.videorecorder.glide.load.resource.bitmap.Downsampler#AT_MOST}.
     *
     * @see #downsample(com.app.videorecorder.glide.load.resource.bitmap.Downsampler)
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.ResourceDecoder} that will be used to decode {@link Bitmap}s obtained
     ...
     * {@link #cacheDecoder(com.app.videorecorder.glide.load.ResourceDecoder)}} with default decoders with the appropriate
     * options set.
     *
     * <p>
    ...
    /**
     * Transform images using the given {@link com.app.videorecorder.glide.load.resource.bitmap.BitmapTransformation}s.
     *
     * @see #centerCrop()
     * @see #fitCenter()
     * @see #transform(com.app.videorecorder.glide.load.Transformation[])
     *
    ...
    /**
     * Transform images using {@link com.app.videorecorder.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transform(com.app.videorecorder.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(com.app.videorecorder.glide.load.Transformation[])
     *
     * @return This request builder.
     */
    ...
    /**
     * Transform images using {@link com.app.videorecorder.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(com.app.videorecorder.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(com.app.videorecorder.glide.load.Transformation[])
