package com.app.videorecorder.glide.request.animation;
 ...
 * {@link com.app.videorecorder.glide.request.target.Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * ({@link com.app.videorecorder.glide.request.animation.ViewAnimation},
     * {@link com.app.videorecorder.glide.request.animation.ViewPropertyAnimation} and animated
     ...
     * @param adapter The {@link com.app.videorecorder.glide.request.animation.GlideAnimation.ViewAdapter} wrapping a view that
     *                can at least return an {@link android.view.View} from
     *                {@link com.app.videorecorder.glide.request.animation.GlideAnimation.ViewAdapter#getView()}.
