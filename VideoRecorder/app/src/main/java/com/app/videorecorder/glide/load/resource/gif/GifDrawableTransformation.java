...
/**
 * An {@link com.app.videorecorder.glide.load.Transformation} that wraps a transformation for a {@link Bitmap}
 * and can apply it to every frame of any {@link com.app.videorecorder.glide.load.resource.gif.GifDrawable}.
 */
