...
/**
 * A class that allows {@link com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder}s to be registered and
...
public class TranscoderRegistry {
    ...
    /**
     * Registers the given {@link com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder} using the given
    ...
    /**
     * Returns the currently registered {@link com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder} for the
     * given classes.
     *
     * @param decodedClass The class of the resource that the transcoder transcodes from.
     * @param transcodedClass The class of the resource that the transcoder transcodes to.
