...
import com.app.videorecorder.glide.load.MultiTransformation;
...
import com.app.videorecorder.glide.load.resource.UnitTransformation;
...
import com.app.videorecorder.glide.provider.ChildLoadProvider;
import com.app.videorecorder.glide.provider.LoadProvider;
import com.app.videorecorder.glide.request.FutureTarget;
import com.app.videorecorder.glide.request.GenericRequest;
import com.app.videorecorder.glide.request.Request;
import com.app.videorecorder.glide.request.RequestCoordinator;
import com.app.videorecorder.glide.request.RequestFutureTarget;
import com.app.videorecorder.glide.request.RequestListener;
import com.app.videorecorder.glide.request.ThumbnailRequestCoordinator;
import com.app.videorecorder.glide.request.animation.GlideAnimationFactory;
import com.app.videorecorder.glide.request.animation.NoAnimation;
import com.app.videorecorder.glide.request.animation.ViewAnimationFactory;
import com.app.videorecorder.glide.request.animation.ViewPropertyAnimation;
import com.app.videorecorder.glide.request.animation.ViewPropertyAnimationFactory;
import com.app.videorecorder.glide.request.target.PreloadTarget;
import com.app.videorecorder.glide.request.target.Target;
import com.app.videorecorder.glide.signature.EmptySignature;
 ...
 * @param <DataType> The data type that the resource {@link com.app.videorecorder.glide.load.model.ModelLoader} will provide that
 *                  can be decoded by the {@link com.app.videorecorder.glide.load.ResourceDecoder}.
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     *     {@link com.app.videorecorder.glide.load.model.ModelLoader}, {@link com.app.videorecorder.glide.load.ResourceDecoder}, and
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.ResourceDecoder} to use to load the resource from the original data.
     * By default, this decoder will only be used if the final transformed resource is not in the disk cache.
     *
     * @see #cacheDecoder(com.app.videorecorder.glide.load.ResourceDecoder)
     * @see com.app.videorecorder.glide.load.engine.DiskCacheStrategy
     *
     * @param decoder The {@link com.app.videorecorder.glide.load.ResourceDecoder} to use to decode the resource.
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.ResourceDecoder} to use to load the resource from the disk cache. By
     * default, this decoder will only be used if the final transformed resource is already in the disk cache.
     *
     * @see #decoder(com.app.videorecorder.glide.load.ResourceDecoder)
     * @see com.app.videorecorder.glide.load.engine.DiskCacheStrategy
     *
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy} to use for this load. Defaults to
     * {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#RESULT}.
     *
     * <p>
     *     For most applications {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#RESULT} is ideal.
     ...
     *     {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#SOURCE} or
     *     {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#RESULT}. Any download only operations should
     *     typically use {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#SOURCE}.
     * </p>
     *
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.Encoder} to use to encode the original data directly to cache. Will only
     * be used if the original data is not already in cache and if the
     * {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy} is set to
     * {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#SOURCE} or
     * {@link com.app.videorecorder.glide.load.engine.DiskCacheStrategy#ALL}.
     *
     * @see #sourceEncoder(com.app.videorecorder.glide.load.Encoder)
     * @see com.app.videorecorder.glide.load.engine.DiskCacheStrategy
     *
    ...
    /**
     * Removes the current {@link com.app.videorecorder.glide.load.Transformation}.
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder} to use for this load.
     *
     * @see com.app.videorecorder.glide.load.resource.transcode.UnitTranscoder
     * @see com.app.videorecorder.glide.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see com.app.videorecorder.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     *
     * @see #animate(int)
     * @see #animate(com.app.videorecorder.glide.request.animation.ViewPropertyAnimation.Animator)
     *
     ...
     * {@link #animate(com.app.videorecorder.glide.request.animation.ViewPropertyAnimation.Animator)}. Scheduled to be removed in
     * Glide 4.0.
     ...
     * memory cache).
     *
     * @param animator The {@link com.app.videorecorder.glide.request.animation.ViewPropertyAnimation.Animator} to run.
     * @return This request builder.
     */
     ...
     * impractical to return that size from {@link Target#getSize(com.app.videorecorder.glide.request.target.SizeReadyCallback)}.
     *
     ...
     * </p>
     *
     * @see com.app.videorecorder.glide.signature.StringSignature
     *
     * @param signature A unique non-null {@link com.app.videorecorder.glide.load.Key} representing the current state of the
     ...
     *
     * <p>
     *      This method must be called at least once before {@link #into(com.app.videorecorder.glide.request.target.Target)} is
     *      called.
     * </p>
     *
     ...
     *
     * @see Glide#clear(com.app.videorecorder.glide.request.target.Target)
     *
     ...
     * @return The {@link com.app.videorecorder.glide.request.target.Target} used to wrap the given {@link ImageView}.
     */
     ...
     *              {@link #override * (int, int)}} if previously called).
     *
     * @see Glide#clear(com.app.videorecorder.glide.request.FutureTarget)
     *
     * @return An {@link com.app.videorecorder.glide.request.FutureTarget} that can be used to obtain the
     ...
     *
     *
     * @see com.app.videorecorder.glide.ListPreloader
     *
     * @param width The desired width in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     *             {@link #override * (int, int)} if previously called.
     * @param height The desired height in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     ...
     *        {@link Glide#clear(com.app.videorecorder.glide.request.target.Target)}.
     */
