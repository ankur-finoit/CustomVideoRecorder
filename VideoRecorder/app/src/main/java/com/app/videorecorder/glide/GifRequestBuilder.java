...
import com.app.videorecorder.glide.load.resource.gif.GifDrawableTransformation;
...
public class GifRequestBuilder<ModelType>
    ...
    /**
     * Transforms each frame of the GIF using {@link com.app.videorecorder.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transformFrame(com.app.videorecorder.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(com.app.videorecorder.glide.load.Transformation[])
    ...
    /**
     * Transforms each frame of the GIF using {@link com.app.videorecorder.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transformFrame(com.app.videorecorder.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(com.app.videorecorder.glide.load.Transformation[])
