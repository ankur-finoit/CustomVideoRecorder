...
import com.app.videorecorder.glide.gifdecoder.GifHeader;
...
public class GifDrawable extends GlideDrawable implements GifFrameLoader.FrameCallback {
     ...
     *
     * @see #setFrameTransformation(com.app.videorecorder.glide.load.Transformation, android.graphics.Bitmap)
     *
     * @param context A context.
     * @param bitmapProvider An {@link com.app.videorecorder.glide.gifdecoder.GifDecoder.BitmapProvider} that can be used to
     *                       retrieve re-usable {@link android.graphics.Bitmap}s.
     * @param bitmapPool A {@link com.app.videorecorder.glide.load.engine.bitmap_recycle.BitmapPool} that can be used to return
     *                   the first frame when this drawable is recycled.
     * @param frameTransformation An {@link com.app.videorecorder.glide.load.Transformation} that can be applied to each frame.
     * @param targetFrameWidth The desired width of the frames displayed by this drawable (the width of the view or
     *                         {@link com.app.videorecorder.glide.request.target.Target} this drawable is being loaded into).
