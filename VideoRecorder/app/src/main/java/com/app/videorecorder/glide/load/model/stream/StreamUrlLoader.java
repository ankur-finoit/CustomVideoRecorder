...
import com.app.videorecorder.glide.load.model.UrlLoader;

import java.io.InputStream;
import java.net.URL;

/**
 * A wrapper class that translates {@link java.net.URL} objects into {@link com.app.videorecorder.glide.load.model.GlideUrl}
 * objects and then uses the wrapped {@link com.app.videorecorder.glide.load.model.ModelLoader} for
 * {@link com.app.videorecorder.glide.load.model.GlideUrl}s to load the {@link java.io.InputStream} data.
 */
public class StreamUrlLoader extends UrlLoader<InputStream> {

    /**
     * The default factory for {@link com.app.videorecorder.glide.load.model.stream.StreamUrlLoader}s.
     */
