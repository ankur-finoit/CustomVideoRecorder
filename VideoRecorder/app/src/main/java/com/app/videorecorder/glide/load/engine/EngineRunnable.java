...
import com.app.videorecorder.glide.load.engine.executor.Prioritized;
import com.app.videorecorder.glide.request.ResourceCallback;

/**
 * A runnable class responsible for using an {@link com.app.videorecorder.glide.load.engine.DecodeJob} to decode resources on a
 ...
 *     {@link com.app.videorecorder.glide.load.engine.DecodeJob} to decode data directly from the original source.
 * </p>
 *
 * <p>
