...
/**
 * A collection of static methods for creating new {@link com.app.videorecorder.glide.RequestManager}s or retrieving existing
 * ones from activities and fragment.
 */
public class RequestManagerRetriever implements Handler.Callback {
    private static final String TAG = "RMRetriever";
    static final String FRAGMENT_TAG = "com.app.videorecorder.glide.manager";
