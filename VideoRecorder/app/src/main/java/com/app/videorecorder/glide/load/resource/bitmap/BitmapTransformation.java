...
/**
 * A simple {@link com.app.videorecorder.glide.load.Transformation} for transforming {@link android.graphics.Bitmap}s that
 * abstracts away dealing with {@link com.app.videorecorder.glide.load.engine.Resource} objects for subclasses.
 *
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
     ...
     *
     * <p>
     *     outWidth and outHeight will never be {@link com.app.videorecorder.glide.request.target.Target#SIZE_ORIGINAL}, this
     *     class converts them to be the size of the Bitmap we're going to transform before calling this method.
     * </p>
     *
     * @param pool A {@link com.app.videorecorder.glide.load.engine.bitmap_recycle.BitmapPool} that can be used to obtain and
