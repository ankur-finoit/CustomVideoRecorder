...
/**
 * An {@link com.app.videorecorder.glide.load.resource.bitmap.BitmapDecoder} that can decode a thumbnail frame
...
public class VideoBitmapDecoder implements BitmapDecoder<ParcelFileDescriptor> {
    ...
    @Override
    public String getId() {
        return "VideoBitmapDecoder.com.app.videorecorder.glide.load.resource.bitmap";
    }
