...
import com.app.videorecorder.glide.load.resource.transcode.GifDrawableBytesTranscoder;
...
/**
 * A class for creating a load request that either loads an {@link com.app.videorecorder.glide.load.resource.gif.GifDrawable}
 * directly or that adds an {@link com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder} to transcode
 * {@link com.app.videorecorder.glide.load.resource.gif.GifDrawable} into another resource type.
 *
 * @param <ModelType> The type of model to load the {@link com.app.videorecorder.glide.load.resource.gif.GifDrawable} or other
...
public class GifTypeRequest<ModelType> extends GifRequestBuilder<ModelType> {
    ...
    /**
     * Sets a transcoder to transcode the decoded {@link com.app.videorecorder.glide.load.resource.gif.GifDrawable} into another
     * resource type.
     *
     * @param transcoder The transcoder to use.
     * @param transcodeClass The {@link Class} of the resource the
     * {@link com.app.videorecorder.glide.load.resource.gif.GifDrawable} will be transcoded to.
     *
     * @param <R> The type of the resource the {@link com.app.videorecorder.glide.load.resource.gif.GifDrawable} will be
     *           trasncoded to.
