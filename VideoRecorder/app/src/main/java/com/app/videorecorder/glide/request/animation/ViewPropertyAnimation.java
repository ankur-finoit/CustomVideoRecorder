...
/**
 * A {@link com.app.videorecorder.glide.request.animation.GlideAnimation GlideAnimation} that accepts an interface
...
public class ViewPropertyAnimation<R> implements GlideAnimation<R> {
     ...
     * {@link com.app.videorecorder.glide.request.animation.ViewPropertyAnimation.Animator} interface that can apply an animation
     * to a view.
     *
    ...
    /**
     * Always applies the {@link com.app.videorecorder.glide.request.animation.ViewPropertyAnimation.Animator} given in the
