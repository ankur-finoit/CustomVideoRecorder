package com.app.videorecorder.glide.load;

/**
 * Options for setting the value of {@link android.graphics.Bitmap#getConfig()} for {@link android.graphics.Bitmap}s
 * returned by a {@link com.app.videorecorder.glide.load.resource.bitmap.BitmapDecoder}.
 *
 * <p>
 *     Note - In some cases it may not be possible to obey the requested setting, not all
 *     {@link com.app.videorecorder.glide.load.resource.bitmap.BitmapDecoder}s support setting formats and certain images may
...
public enum DecodeFormat {
    /**
     * All bitmaps returned by the {@link com.app.videorecorder.glide.load.resource.bitmap.BitmapDecoder} should return
