...
import com.app.videorecorder.glide.load.data.FileDescriptorAssetPathFetcher;
import com.app.videorecorder.glide.load.data.FileDescriptorLocalUriFetcher;
...
public class FileDescriptorUriLoader extends UriLoader<ParcelFileDescriptor> implements FileDescriptorModelLoader<Uri> {
    ...
    /**
     * The default factory for {@link com.app.videorecorder.glide.load.model.file_descriptor.FileDescriptorUriLoader}s.
     */
