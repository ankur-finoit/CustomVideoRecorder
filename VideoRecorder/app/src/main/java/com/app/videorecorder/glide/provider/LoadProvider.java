...
/**
 * An extension of {@link com.app.videorecorder.glide.provider.DataLoadProvider} that also allows a
 * {@link com.app.videorecorder.glide.load.model.ModelLoader} and a
 * {@link com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder} to be retrieved.
 *
...
public interface LoadProvider<A, T, Z, R> extends DataLoadProvider<T, Z> {
    ...
    /**
     * Returns the {@link com.app.videorecorder.glide.load.model.ModelLoader} to convert from the given model to a data type.
     */
    ModelLoader<A, T> getModelLoader();

    /**
     * Returns the {@link com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder} to convert from the decoded
