package com.app.videorecorder.glide.module;

import android.content.Context;

import com.app.videorecorder.glide.Glide;
import com.app.videorecorder.glide.GlideBuilder;

/**
 * An interface allowing lazy configuration of Glide including setting options using
 * {@link com.app.videorecorder.glide.GlideBuilder} and registering
 * {@link com.app.videorecorder.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p>
 ...
 *             {@link com.app.videorecorder.glide.Glide#register(Class, Class, com.app.videorecorder.glide.load.model.ModelLoaderFactory)}
 *             for each {@link com.app.videorecorder.glide.load.model.ModelLoader} you'd like to register:
 *             <pre>
 *                  <code>
 ...
 *              <pre>
 *                  {@code
 *                      -keepnames class * com.app.videorecorder.glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 *         </li>
 *         <li>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="com.app.videorecorder.glide.samples.flickr.FlickrGlideModule"
...
public interface GlideModule {
    ...
    /**
     * Lazily apply options to a {@link com.app.videorecorder.glide.GlideBuilder} immediately before the Glide singleton is
     * created.
     *
     * <p>
     ...
     * @param builder The {@link com.app.videorecorder.glide.GlideBuilder} that will be used to create Glide.
     */
