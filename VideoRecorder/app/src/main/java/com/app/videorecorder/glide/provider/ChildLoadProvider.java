package com.app.videorecorder.glide.provider;
...
/**
 * A {@link com.app.videorecorder.glide.provider.LoadProvider} that returns classes preferentially from those set on it but
 * that also defaults to a wrapped {@link com.app.videorecorder.glide.provider.LoadProvider} when a particular class is not set.
 *
...
public class ChildLoadProvider<A, T, Z, R> implements LoadProvider<A, T, Z, R>, Cloneable {
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.ResourceDecoder} to use for decoding the resource from the disk cache.
     *
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.ResourceDecoder} to use to decoding the resource from the original data.
     *
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.ResourceEncoder} to use to write the decoded and transformed resource to
     * the disk cache.
     *
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.resource.transcode.ResourceTranscoder} to use to transcode the decoded
     * resource.
     *
    ...
    /**
     * Sets the {@link com.app.videorecorder.glide.load.Encoder} to use to write the original data to the disk cache.
     *
